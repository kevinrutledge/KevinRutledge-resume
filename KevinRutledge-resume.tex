...
% Acknowledgment for the original template
% Resume template adapted from 'Jake's Resume' on Overleaf
% Original template available at: https://www.overleaf.com/latex/templates/jakes-resume/syzfjbzwjncs
